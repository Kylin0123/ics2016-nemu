...
/* 0x80 */
make_group(group1_b,
	inv, or_i2rm_b, adc_i2rm_b, sbb_i2rm_b, 
	inv, inv, xor_i2rm_b, inv)

/* 0x81 */
make_group(group1_v,
	inv, or_i2rm_v, adc_i2rm_v, sbb_i2rm_v, 
	inv, inv, xor_i2rm_v, inv)

/* 0x83 */
make_group(group1_sx_v,
	add_i_b2rm_v, or_si2rm_v, adc_si2rm_v, sbb_si2rm_v, 
	and_si2rm_v, sub_i_b2rm_v, xor_si2rm_v, cmp_i_b2rm_v)
...
/* 0x84 */	je_si_v, test_r2rm_v, inv, inv,
...
/* 0xe8 */	call_si_v, inv, inv, jmp_si_b,
