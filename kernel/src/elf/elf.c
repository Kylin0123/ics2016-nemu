	...
	for(i = 0; i < elf->e_phnum; i++) {
		...
		if(ph->p_type == PT_LOAD) {
			 ...
			 */
             ...
             memcpy( (void *)(ph->p_vaddr + elf->e_ehsize + elf->e_phentsize * elf->e_phnum), (void *)(elf->e_ehsize + elf->e_phentsize * elf->e_phnum), ph->p_filesz);
			/* TODO: zero the memory region 
			 * [VirtAddr + FileSiz, VirtAddr + MemSiz)
			 */
             memset((void *)(ph->p_vaddr + ph->p_filesz + elf->e_ehsize + elf->e_phentsize * elf->e_phnum), 0, ph->p_memsz - ph->p_filesz);
